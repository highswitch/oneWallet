<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="monitorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="节点列表" align="center" prop="nodes" />
      <el-table-column label="邮箱地址" align="center" prop="emails" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除fifox监听编号为"' + ids + '"的数据项？').then(function() {
